...
import { getFeaturedTranscripts } from "@/utils";
import { Transcript, allTranscripts } from "contentlayer/generated";
...
const FeaturedTranscriptClient = ({
  ...
  const [data, setData] = React.useState<Transcript[]>(featuredTranscripts);

  const randomise = () => getFeaturedTranscripts(allTranscripts, setData);
