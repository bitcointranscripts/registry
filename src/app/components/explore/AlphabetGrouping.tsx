...
const AlphabetGrouping = ({
  ...
  return (
    <div
      className={
        "fixed top-10 right-20 grid grid-cols-5 p-5 gap-4  xl:gap-6 xl:p-6 max-w-[max-content] xl:max-w-[355px] w-full border border-gray-custom-1200 rounded-md"
      }
    >
