      ...
      {showDetail && (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-2 md:gap-16">
          ...
          <div className="flex flex-col gap-2 border-b py-3  border-dashed border-[#BEBEBE]">
            ...
            <div className="pl-5">
              <p className=" text-xs md:text-lg md:font-medium">7 March, 2024</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 border-b py-3  border-dashed border-[#BEBEBE]">
            <div className="flex items-center gap-1">
              <PencilEdit />
              <p className="text-base md:text-lg font-semibold">Transcript by</p>
            </div>
            <div className="pl-5">
              <p className="text-xs md:text-lg md:font-medium">{transcriptBy}</p>
            </div>
          </div>
        </div>
      )}
