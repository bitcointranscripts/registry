  ...
  return (
    <div className='flex items-start relative lg:gap-[50px]'>
      <div className='flex flex-col w-full gap-6 lg:gap-10 no-scrollbar'>
        <div className='block lg:hidden sticky top-0'></div>
        <div className='flex flex-col border-b border-b-[#9B9B9B] pb-6 lg:pb-10 gap-6'>
          ...
          <div className='flex flex-col gap-1 lg:gap-4'>
            ...
            <h3 className='text-xl 2xl:text-2xl font-medium'>
              {current["_index"] ? current["_index"][0].title : Array.isArray(current) ? directoryData?.title : slug[slug.length - 1]}
            </h3>
          </div>
        </div>
      ...
      <div className='hidden lg:flex sticky top-0 flex-shrink-0  w-fit lg:justify-center 2xl:min-w-[354px]'></div>
    </div>
  );
};
