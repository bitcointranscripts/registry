    ...
    <div className='flex flex-col items-center justify-center w-full'>
      <Wrapper className='pt-16 pb-20 gap-6 flex justify-between max-md:flex-col max-md:px-6 max-md:gap-8 max-md:pt-6 max-md:pb-8 w-full'>
        <section className='flex justify-between w-[50%] gap-8 max-md:flex-col max-md:w-full'>
          <section className='flex flex-col gap-6 max-w-[400px] max-md:gap-4 max-md:max-w-full max-md:w-full'>
            <Logo iconStyles='w-14 max-xl:w-[45px]' textStyles='text-5xl text-black max-xl:text-[32px] dark:text-gray-custom-100' />
            <p className='font-medium sm:text-sm md:text-base xl:text-lg text-gray-custom-800 dark:text-gray-custom-100 max-xl:text-base max-md:text-sm'>
              Community-maintained archive to unlocking knowledge from technical bitcoin transcripts
            </p>
          </section>
          <section className='flex flex-col gap-12 text-black dark:text-gray-custom-100 font-bold text-xl underline max-xl:text-base max-xl:gap-8 max-md:gap-4'>
        ...
        <section className='flex flex-col gap-6 max-md:gap-4'>
          <h4 className='text-black dark:text-gray-custom-100 text-xl max-md:text-base '>Explore all Products</h4>
      ...
      <Wrapper className='py-10 max-md:pt-8 max-md:pb-[67px] max-lg:px-2 w-full'>
        <Footer className="dark:bg-dark-custom-100 dark:text-gray-custom-100">
          ...
          />
          <Footer.About entityLink='https://bitcoindevs.xyz' entityName='Bitcoin Dev Project' className="dark:text-gray-custom-100" />
          <Footer.Public dashboardLink='https://visits.bitcoindevs.xyz/share/7hL0ysupLrZQsKRw/btc-transcripts' className="dark:text-gray-custom-100" />
          <Footer.Feedback feedbackLink='https://cryptpad.fr/form/#/2/form/view/3P2CsohsHOkcH7C+WdtX0-tvqjBHqXnAmz5D9yx0e04/' className="dark:text-gray-custom-100" />
        </Footer>
      </Wrapper>
    </div>
  );
