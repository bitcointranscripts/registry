...
const FeaturedTranscripts = () => {
  ...
  return (
    <div className='flex items-center justify-center w-full bg-gray-custom-100 dark:bg-dark-custom-100'>
      <Wrapper className='py-[104px] flex flex-col gap-14 text-black dark:text-gray-custom-100 max-md:py-16 max-md:gap-12'>
