              ...
              <div className='flex gap-[9px] flex-wrap'>
                <div className='flex flex-wrap gap-[9px] max-md:gap-2'>
                  {data?.speakers.slice(0, 2).map((speaker, idx) => (
                    <p
                      key={idx}
                      className='py-[4.11px] px-[16.43px] rounded-[5.13px]
                      bg-gray-custom-700 dark:bg-gray-custom-1800 dark:border-0 max-md:px-3
                      max-md:py-[2px] max-xl:text-[13px] dark:text-gray-custom-100
                      max-md:text-sm max-md:border max-md:border-gray-custom-300
                      max-md:leading-[100%]'
                    >
                      {speaker}
                    </p>
